...
> הפדגוגי המכוון בין החצי ההצהרתי של הקורס לחצי המחושב-חי.

---

## 1. הסיכום בשורה אחת

הקורס כבר בנוי על **מקור אמת אחד למנוע** (פרקים 5→13 מייבאים זה מזה בשרשרת)
...
שני חצאי הקורס מדרגים את אותו משפט ("החבילה לא הגיעה") בשלוש דרכים, בכוונה:
...
## 6. חוטי היושרה של הקורס (לשמירה בכל שינוי עתידי)
