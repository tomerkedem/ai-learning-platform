...
export const mistakeLearningLab: MistakeLearningLabContent = {
    ...
    initialAnswer: 'The package will arrive tomorrow.',
    correctionLabel: 'Your correction',
    correction: 'That is not right. The tracking says there is no confirmed arrival date.',
    ...
    modes: [
        {
            ...
            steps: [
                { id: 'context-1', label: 'First answer', text: 'The model answers: "The package will arrive tomorrow." That is a claim with no source.', tone: 'wrong' },
                { id: 'context-2', label: 'Your correction', text: 'You write: "That is not right. There is no confirmed arrival date in the source."', tone: 'context' },
                { id: 'context-3', label: 'The context updates', text: 'The correction becomes part of the context of this conversation.', tone: 'context' },
                { id: 'context-4', label: 'Revised answer', text: 'The model answers again: "Right. According to the tracking, the package is delayed and there is no confirmed arrival date."', tone: 'good' },
            ],
            beforeAfter: {
                beforeLabel: 'Before the correction',
                before: 'The package will arrive tomorrow.',
                afterLabel: 'After the correction',
                after: 'According to the tracking, the package is delayed. There is no confirmed arrival date.',
            },
        ...
        },
        {
            ...
            steps: [
                { id: 'system-1', label: 'A recurring pattern', text: 'The system invents an arrival date when the source has none, again and again.', tone: 'wrong' },
                { id: 'system-2', label: 'Improving the prompt', text: 'A rule is added to the prompt: do not invent an arrival date that is not in the source.', tone: 'system' },
                { id: 'system-3', label: 'Improving the source', text: 'The source card is improved so it explicitly marks "date not available".', tone: 'system' },
        ...
        },
        {
            ...
            steps: [
                ...
                { id: 'eval-2', label: 'Previous version', text: 'Answered "will arrive tomorrow". Failed, because it invented a date that is not in the source.', tone: 'wrong' },
                { id: 'eval-3', label: 'New version', text: 'Answered "there is no confirmed date". Passed, because it relied on the source.', tone: 'good' },
            ...
            beforeAfter: {
                ...
                before: 'Invents an arrival date when the source has none.',
                afterLabel: 'New version',
                after: 'Says there is no confirmed arrival date.',
            },
