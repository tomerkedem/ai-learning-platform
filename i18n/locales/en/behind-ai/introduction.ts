...
export const introduction = {
    ...
    // ── Course structure: 16 chapters, 5 systems (CourseSystems) ──
    systems: {
        heading: {
            eyebrow: 'The journey ahead',
            title: '16 chapters that open the engine, step by step',
            summary: '16 chapters, 5 systems, one engine that opens up gradually',
        ...
        items: {
            outside: {
                title: 'The outside view and a transparent chat',
                range: 'Chapters 1-4',
                teaser: 'Behind "request and answer" hides a full route. This is where you start to see it.',
                purpose: 'To break the illusion that chat is just request and answer, and to start seeing the transparent engine.',
                stationChips: ['The request comes in', 'Looping until an answer'],
                chapters: ['The road to the answer', 'The first decision', 'The probabilistic heart', 'Word after word'],
            },
            representations: {
                title: 'From text to tokens and representations',
                range: 'Chapters 5-7',
                teaser: 'How does text become something you can compute on? This is where it happens.',
                purpose: 'To understand how text becomes tokens, IDs, and numeric representations the model can compute on.',
                stationChips: ['Breaking into tokens', 'Token IDs', 'Embedding'],
                chapters: ['Text breaks apart', 'From words to numbers', 'The space of meaning'],
            },
            context: {
                title: 'Context, scores, and probabilities',
                range: 'Chapters 8-9',
                teaser: 'The same word, a different meaning depending on context. This is where things get ranked and chosen.',
                purpose: 'To understand how context affects the ranking of options, and how scores turn into probabilities and a decision.',
                stationChips: ['Attention', 'Logits', 'Softmax'],
                chapters: ['Similarity, scores, and probabilities', 'When to answer and when to stop'],
            },
            agent: {
                title: 'From Chat to Agent',
                range: 'Chapters 10-13',
                teaser: 'What happens when the model can also act, not just write?',
                purpose: 'To understand what changes when a system around the model can choose a tool, check risk, ask for approval, or stop.',
                stationChips: ['A layer around the engine, beyond the 14 stations'],
                chapters: ['From prompt to task', 'Choosing a tool', 'Running a tool and its result', 'Stopping and responsibility'],
            },
            synthesis: {
                title: 'Synthesis and skill',
                range: 'Chapters 14-16',
                teaser: 'Everything you have seen comes together here into one picture.',
                purpose: 'To connect all the stations into one picture, check understanding, and practice working smartly with AI.',
                stationChips: ['All 14 stations'],
                chapters: ['The unified lab', 'Does AI learn from mistakes', 'Working well with AI'],
            },
        },
    },
