...
export const evaluationLab: EvaluationLabContent = {
    ...
    trainedLabel: 'The example it was corrected on',
    trainedCustomer: 'My package was supposed to arrive yesterday. Where is it?',
    trainedAnswerLabel: 'The good answer it learned',
    ...
    disclaimer:
        'Every example here is for teaching only. There is no real benchmark and no claim about the policy of a specific product. The goal is to show how evaluation checks behavior across varied cases, and not only on one example.',
    sr: {
    ...
    cases: [
        {
            ...
            verdict: 'pass',
            reveals: 'The model passes the familiar case. That is good, but one example is still not a test. We need to see what happens when the case changes.',
        },
        {
            id: 'paraphrase',
            caseType: 'paraphrase',
