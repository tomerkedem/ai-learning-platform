...
export const chapter3Lab: Chapter3LabContent = {
    ...
    splitter: {
        ...
        placeholder: 'For example: The laundry did not dry',
    ...
    signals: {
        ...
        deliveryFailure: { label: 'Negation signal', en: 'Negation signal' },
        sortingCenter: { label: 'Coffee cup phrase', en: 'Coffee cup phrase' },
    },
    ...
    subword: {
        ...
        splits: [
            { word: 'unfold', whole: ['unfold'], units: ['un', 'fold'], roleLabel: 'Prefix', roleEn: 'Prefix', note: 'The prefix "un" can split from the base "fold".' },
            { word: 'reheat', whole: ['reheat'], units: ['re', 'heat'], roleLabel: 'Prefix', roleEn: 'Prefix', note: 'The prefix "re", meaning again, can split from the base "heat".' },
            ...
            { word: 'rewrite', whole: ['rewrite'], units: ['re', 'write'], roleLabel: 'Prefix', roleEn: 'Prefix', note: 'The prefix "re" can split from the base "write".' },
        ],
    },
    ...
    scenarios: [
        {
            ...
            labelHe: 'Chat mode',
            labelEn: 'Chat mode',
            prompt: 'The laundry did not dry',
            accent: 'emerald',
            routeHe: 'Build answer',
            routeEn: 'Build answer',
            examples: [
                { labelHe: 'Base', labelEn: 'Base', text: 'The laundry did not dry' },
                { labelHe: 'With question', labelEn: 'With question', text: 'The laundry did not dry?' },
                { labelHe: 'With emphasis', labelEn: 'With emphasis', text: 'My laundry did not dry!!!' },
                { labelHe: 'Recipe quantity', labelEn: 'Recipe quantity', text: 'The recipe needs 250 grams of flour' },
                { labelHe: 'No spaces', labelEn: 'No spaces', text: 'Thelaundrydidnotdry' },
                { labelHe: 'In Spanish', labelEn: 'In Spanish', text: 'La ropa no se seco' },
                { labelHe: 'Correction', labelEn: 'Correction', text: 'Not cookies, I baked a cake' },
            ],
        },
        {
            id: 'agent-check',
            ...
            labelHe: 'Agent mode',
            labelEn: 'Agent mode',
            prompt: 'Check why the cat did not return',
            accent: 'purple',
            routeHe: 'Understand task',
            routeEn: 'Understand task',
            examples: [
                { labelHe: 'Investigation', labelEn: 'Investigation', text: 'Check why the cat did not return' },
                { labelHe: 'To recipient', labelEn: 'To recipient', text: 'Check why the cat did not return to the child' },
            ],
        },
    ],
    ...
    roleInfo: {
        ...
        context: { label: 'Context', en: 'Context / Location', why: 'Adds a place or context that sharpens the picture, such as where you drank your coffee.' },
        system: { label: 'System', en: 'System', why: 'Points to a wider system, not the object itself. Same area, but a different direction.' },
        ...
        number: { label: 'Number', en: 'Number', why: 'A run of digits is a unit of its own. A recipe quantity, for example, turns a general request into something precise and measurable.' },
    ...
    sortingCenter: { leads: ['cup'], follow: 'coffee' },
