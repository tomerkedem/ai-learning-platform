...
export const chapter1Visuals = {
    ...
    enginePanel: {
        ...
        productEnvelope: {
            ...
            systemInstructionExample: 'Answer music-playback questions briefly in English.',
            selectedContextExample: 'Selected context: music app support; no external playback data.',
    ...
    journey: {
        ...
        agent: {
            ...
            stations: {
                ...
                a3: { title: 'Available tools', note: 'The product may expose permitted tools such as playlist lookup or deletion. MCP is one possible protocol, not a requirement.' },
            ...
            toolNames: ['Playlist lookup', 'Delete a playlist'],
            mcp: 'MCP (optional)',
            observation: 'Example after a tool call: playlist details received',
            missingOn: 'Missing identifier (Playlist ID)',
    ...
    trace: {
        labels: {
            ...
            decision: {
                ...
                'Use the Playlist API': 'Use the playlist tool',
                'Use the Playlist deletion tool': 'Use the playlist deletion tool',
                'Ask for the Playlist ID before acting': 'Ask for a Playlist ID before acting',
    ...
    mockEngine: {
        ...
        agentReplies: {
            sensitive: 'This is an action that deletes a playlist. I will not perform it without verification and approval - I can prepare a draft for approval.',
            tool: 'There is a Playlist ID. I am checking the details in the playlist tool...',
