...
export const chatToAgentLab: ChatToAgentLabContent = {
    ...
    sectionTitle: 'Same request, four modes',
    sectionIntro:
        'The request is fixed: "Check what is happening with the package and update the customer." Move between the four modes and see how the same request is answered once as text, once as a request for information, once with a tool, and once as a draft that stops for approval.',
    ...
    modes: [
        ...
        },
        {
            ...
            takeaway: 'The agent uses the tool result to move forward. It does not guess the status.',
        },
        {
            id: 'approval',
            modeType: 'approval',
            ...
            note: 'The draft is ready, but it was not sent. An action toward a real customer waits for your approval.',
