...
export const guardrailsLab: GuardrailsLabContent = {
    ...
    sectionTitle: 'Same task, five actions, five decisions',
    sectionIntro:
        'The task is fixed: "Check the package and update the customer." Move between the five actions and see how the control layer decides, for each one, whether to continue, ask, prepare a draft only, stop for approval, or block.',
    ...
    actions: [
        ...
        },
        {
            ...
            checks: [
                ...
                { label: 'Permission', state: 'warn', note: 'It requires human approval before it runs.' },
            ],
        ...
        },
        {
            ...
            checks: [
                ...
                { label: 'Permission', state: 'fail', note: 'A forbidden action, it does not pass even with approval.' },
            ],
