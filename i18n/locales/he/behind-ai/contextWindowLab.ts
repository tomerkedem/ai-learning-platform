...
export const contextWindowLab: ContextWindowLabContent = {
    ...
    states: [
        ...
        },
        {
            ...
            answerTone: 'generic',
            caption:
                'השיחה התארכה, וההודעה עם הפרט הקריטי כבר יצאה מחלון ההקשר. המודל לא רואה אותה עכשיו, ולכן הוא נאלץ לענות בכלליות או לבקש את המידע החסר. הפרט קיים בהיסטוריה, אבל לא בתוך מה שהמודל מעבד ברגע הזה.',
        },
        {
            id: 'restored',
