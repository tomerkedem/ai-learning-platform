...
export const attention = {
    ...
    prompt: 'האור כבוי, אבל היא אומרת שהוא דלוק.',
    ...
    primer: {
        ...
        points: [
            ...
            },
            {
                ...
                body: 'במשפט "האור כבוי, אבל היא אומרת שהוא דלוק", העיקר הוא לא מילה בודדת אלא המתח בין "כבוי" לבין "דלוק". שם הקשב צריך להיות חזק, כי זו הסתירה שהתשובה חייבת לטפל בה.',
            },
            {
                title: 'מילים קטנות שמזיזות את הקשר',
                body: 'מילים כמו "אבל", שלילה ("לא"), תנאים ("רק אם"), חריגים וכינויים ("שהוא") משנים אילו קשרים נעשים חשובים. שינוי קטן כזה יכול להזיז לגמרי את מוקד הקשב.',
            },
            {
                title: 'מה Attention הוא לא',
                body: 'הקשב הוא לא תודעה ולא הבנה אנושית. אין למודל רגע של "הבנתי". והוא גם לא בדיקת אמת: משקל קשב גבוה על "כבוי" לא אומר שהאור באמת כבוי, אלא רק שהמילה חשובה לעיבוד ההקשר.',
            },
        ],
    },
    ...
    everyday: {
        title: 'רגע מהחיים',
        body:
            'כשאדם קורא "האור כבוי, אבל היא אומרת שהוא דלוק", הוא נעצר רגע ב"אבל". המילה הזו משנה איך קוראים את כל ההמשך. חשוב לזכור: המודל לא נעצר ולא מבין כמו אדם. אין לו רגע של "הבנה". מנגנון הקשב רק נותן לו דרך מתמטית לשקלל אילו חלקים בטקסט קשורים זה לזה חזק יותר, ולפי זה לערבב את המידע.',
    },
    ...
    lock: {
        ...
        explanationPair: '"כבוי" מול "דלוק"',
        explanationRest:
            '. העיקר הוא לא רק שיש חוסר ודאות לגבי האור, אלא הסתירה בין הטענה הראשונה לבין מה שהיא מדווחת. שם הקשב צריך להיות חזק כדי שהתשובה לא תניח דבר שעוד לא נבדק.',
    },
    ...
    guess: {
        ...
        revealCopy:
            'Attention לא מחפש מילה אחת מנצחת, ולא בודק מה נכון בעולם. הוא שוקל את הקשר בין חלקי המשפט. כשצריך לזהות את הבעיה, "כבוי" מקבלת משקל. כשצריך לזהות את הסתירה, הקשר בין "כבוי" לבין "דלוק" נהיה חשוב. וברגע שמשנים מילה במשפט, כמו מסירים את "אבל" או מחליפים את הטענה הסותרת, הקשב זז מיד.',
        ...
        cards: {
            'one-word': {
                ...
                getsRight: 'ברגע מסוים מילה כמו "כבוי" או "דלוק" באמת יכולה לקבל הרבה משקל.',
            ...
            'factcheck': {
                ...
                desc: 'המודל מתמקד במילים שיעזרו לו לבדוק אם האור באמת כבוי.',
                statusLabel: 'חשוב, אבל לא Attention',
                getsRight: 'ההבחנה חשובה. באמת צריך לבדוק מה מצבו של האור.',
                missesLabel: 'מה זה מפספס',
                misses: 'אבל זו לא עבודת ה-Attention. הוא לא בודק אם משהו נכון בעולם.',
                bridge: 'Attention יכול לזהות את המתח בין "כבוי" לבין "דלוק", אבל בדיקה אמיתית דורשת מקור מידע חיצוני או כלי.',
            },
        },
    },
