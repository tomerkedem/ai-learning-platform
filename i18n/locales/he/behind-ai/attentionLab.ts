...
export const attentionLab: AttentionLabContent = {
    ...
    disclaimer:
        'זו המחשה לימודית מפושטת, לא שיקוף מלא של מנגנון Attention במודל אמיתי. המספרים כאן נועדו להראות את הרעיון: שינוי קטן במשפט מזיז את מוקד הקשב ואת עוצמת הקשר בין החלקים.',
    tensionLabels: {
        high: 'קשר חזק',
        medium: 'קשר בינוני',
        low: 'קשר חלש',
