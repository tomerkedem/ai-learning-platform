...
//
// הרעיון המרכזי: המודל תוקן על דוגמה אחת (אל תמציא שעות חג כשאין שעות חג במקור).
...
export const evaluationLab: EvaluationLabContent = {
    ...
    sectionIntro:
        'המודל תוקן על דוגמה אחת: אל תמציא שעות חג כשאין שעות חג במקור. עכשיו נבדוק אם הוא מחזיק את העיקרון גם כשהמקרה משתנה. עברו בין חמישה מקרי בדיקה וראו איפה הוא עומד בעיקרון, ואיפה הוא נכשל.',
