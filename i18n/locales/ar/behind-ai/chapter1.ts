...
export const chapter1 = {
    ...
    redesign: {
        ...
        failures: { title: 'نتيجة واحدة ومصادر خلل متعددة', intro: 'الإجابة الضعيفة لا تعني فورا أن النموذج هلوس. اختر طبقة محتملة.', groupLabel: 'مصادر الخلل المحتملة', conclusion: 'قد لا تكشف الإجابة النهائية وحدها المصدر الدقيق. افحص المسار لا نهايته فقط.', items: [{ title: 'طلب غير واضح', body: 'قد تكون المشكلة في صياغة المستخدم.' }, { title: 'مدخل مفقود', body: 'لم يكتب أو يرفق تفصيل لازم.' }, { title: 'تعليمة منتج خاطئة', body: 'قدم المنتج تعليمة ناقصة أو غير مناسبة.' }, { title: 'اختيار سياق خاطئ', body: 'أرفق النظام سياقا خاطئا أو حذف سياقا مهما.' }, { title: 'خطأ توليد في النموذج', body: 'ولد النموذج خرجا خاطئا أو غير مدعوم.' }, { title: 'معلومات خارجية مفقودة أو قديمة', body: 'المصدر الخارجي غير متاح أو غير محدث.' }, { title: 'فشل استرجاع أو أداة', body: 'فشل البحث أو الأداة أو التكامل.' }, { title: 'حظر سياسة أو إذن', body: 'حظرت قاعدة أو صلاحية الإجراء.' }, { title: 'تنسيق أو عرض', body: 'تضرر الخرج بعد النموذج وقبل الشاشة.' }] },
        ...
        bridge: { title: 'السؤال الطبيعي التالي', question: 'نعرف الآن أن المنتج يجمع شيئا قبل أن يجيب النموذج. ما الذي يدخل إلى النموذج بالضبط؟', body: 'يفتح الفصل التالي ظرف المدخل من دون افتراض أن الرسالة الظاهرة هي كل ما استلمه النموذج.', cta: 'مدخل النموذج: ما الذي يدخل فعلا' },
    },
