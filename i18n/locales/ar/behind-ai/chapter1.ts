...
export const chapter1 = {
    ...
    deep: {
        ...
        hint: 'هنا تنفتح الأدوات المتقدمة: رأس قراءة حيّ، وتجربة تُظهر أي كلمة حسمت. يمكنك الاستكشاف بوتيرتك الخاصة.',
        intro1: 'انظر طبقة عمق: من هنا يصبح الأمر أكثر تقنية. أمامك مختبران مرقّمان، كل منهما يُظهر زاوية مختلفة من المسار نفسه. لا حاجة لإنهاء كل شيء دفعةً واحدة.',
        intro2Lead: 'في ',
    ...
    summary: {
        ...
        understandBody: 'محرك الذكاء الاصطناعي لا "يعرف" الجواب - بل يرتّب الخيارات، ويقرر وفق الفارق بينها. عندما يكون الفارق كبيرًا يجيب بثقة؛ وعندما يكون الفارق صغيرًا، فالخطوة الصحيحة هي التوقف والسؤال، لا التخمين. رأيت هذا بنفسك: أظهر رأس القراءة المتصدّر يتبدّل أثناء القراءة، وكلمة واحدة استُبدلت قلبت قرارًا كاملًا.',
