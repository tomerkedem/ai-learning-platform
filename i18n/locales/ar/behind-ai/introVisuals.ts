...
export const introVisuals = {
    ...
    viz: {
        ...
        mix: {
            ...
            caption: 'بعد الانتباه، يمرّ كل توكن عبر شبكة feed-forward تُثريه. في النماذج الكبيرة يُضيء الراوتر بضعة خبراء فقط من بين كثيرين - هذا هو Mixture-of-Experts: معرفة هائلة، لكن جزءًا صغيرًا فقط يعمل لكل توكن. "الخبراء" ليسوا خبراء بشريين في مواضيع: التوجيه يُتعلَّم أثناء التدريب، وهو رقمي بالكامل، ولا يمكن قراءته مباشرة.',
        },
        ...
        state: {
            ...
            caption: 'كل السياق مضغوط في نقطة واحدة. منها ستولد الكلمة التالية. السياق نفسه لا يُمحى: في كل دورة يعود النموذج وينظر إليه من جديد.',
        },
