...
export const introVisuals = {
    ...
    viz: {
        ...
        mix: {
            ...
            caption: 'بعد الانتباه، يمرّ كل توكن عبر شبكة feed-forward تُثريه. في النماذج الكبيرة يُضيء الراوتر بضعة خبراء فقط من بين كثيرين - هذا هو Mixture-of-Experts: معرفة هائلة، لكن جزءًا صغيرًا فقط يعمل لكل توكن.',
        },
