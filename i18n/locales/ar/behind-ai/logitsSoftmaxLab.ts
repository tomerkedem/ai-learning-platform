...
export interface LabContinuation {
    ...
    id: string;
    /** تسمية الاستكمال، مثل "سيكون غائما". */
    label: string;
}
...
export interface LabContext {
    ...
    /** تسمية الزر. */
    control: string;
    /** الإضافة السياقية التي تدخل البرومبت قبل "الطقس اليوم على الأرجح...". فارغة في الوضع المحايد. */
    promptExtra?: string;
...
export const logitsSoftmaxLab: LogitsSoftmaxLabContent = {
    ...
    promptBase: 'الطقس اليوم على الأرجح...',
    ...
    continuations: [
        { id: 'delayed', label: 'سيكون غائما' },
        { id: 'delivered', label: 'سيكون مشمسا' },
        { id: 'pickup', label: 'سيكون ممطرا' },
        { id: 'lost', label: 'ستكون عاصفة' },
    ],
    contexts: [
        {
            id: 'neutral',
            control: 'دون معلومة إضافية',
            note: 'دون معلومة إضافية، ينال "سيكون غائما" الدرجة الأعلى. الدرجات متقاربة، لكن Softmax يفرد الاحتمالات بفارق ملحوظ بالفعل. ما زال الأمر تقديرا، لا معرفة.',
            scores: { delayed: 4, delivered: 3, pickup: 2, lost: 1 },
        },
        {
            id: 'delay',
            control: 'غائم منذ الصباح',
            promptExtra: 'كانت السماء رمادية وغائمة منذ الصباح الباكر.',
            note: 'التلميح "غائم منذ الصباح" يعزّز "سيكون غائما" ويشحذ التوزيع حوله. الاستكمالات نفسها تماما، بدرجات مختلفة.',
            scores: { delayed: 5, delivered: 2, pickup: 2, lost: 3 },
        },
        {
            id: 'delivered',
            control: 'توقع سماء صافية',
            promptExtra: 'يُظهر التوقع سماء صافية ورطوبة منخفضة.',
            note: 'توقع سماء صافية ينقل الصدارة إلى "سيكون مشمسا". لم يتحقق النموذج من السماء فعليا، بل رجّح فقط ما هو مكتوب في السياق.',
            scores: { delayed: 3, delivered: 5, pickup: 2, lost: 2 },
        },
        {
            id: 'pickup',
            control: 'مطر على الرادار',
            promptExtra: 'تُظهر أحدث بيانات الرادار حزام مطر يقترب.',
            note: 'تفصيل "مطر على الرادار" يرفع الاستكمال المناسب إلى الصدارة، دون تغيير مجموعة الاستكمالات. السياق هو من يحدد المتصدّر.',
