...
export const logitsSoftmaxLab: LogitsSoftmaxLabContent = {
    ...
    softmaxNote:
        'يوزّع Softmax مئة بالمئة بين الاستكمالات حسب الدرجات: الدرجة الأعلى تنال حصة أكبر. فارق صغير في الدرجة قد يفتح فارقا ملحوظا في النسب، ولذلك يكفي تغيير بسيط في السياق كي تتحرك الصورة.',
    continuationNote:
        'تُعرض الاستكمالات هنا كعبارات كاملة كي تسهل قراءتها. في الواقع يرتّب النموذج الرمز التالي خطوة بعد خطوة. هذا توضيح للتنافس ذاته، لا أثر داخلي دقيق للنموذج.',
    disclaimer:
        'الدرجات والنسب هنا توضيح تعليمي، لا مخرجات حقيقية لنموذج. الهدف منها إظهار كيف تتحول الدرجات إلى احتمالات، وكيف يحرّكها السياق. الدرجة العالية تعني أن الاستكمال أكثر ترجيحا حسب النص، لا أنه صحيح في العالم.',
    sr: {
        increase: 'ارفع درجة',
        decrease: 'اخفض درجة',
    ...
    contexts: [
        {
            ...
            note: 'دون معلومة إضافية، ينال "تأخّرت" الدرجة الأعلى، لكن الفارق بين الاستكمالات ليس كبيرا. ما زال الأمر تقديرا، لا معرفة.',
