...
export const chapter4Lab: Chapter4LabDict = {
    ...
    map: {
        ...
        numericTitle: 'التمثيل الرقمي',
        numericNote: 'الأشياء المتشابهة في المعنى تحصل على أرقام متشابهة، لذا تجلس قريبة على الخريطة. المتجه العشوائي لا يجمعها.',
        numericDisclaimer: 'الأرقام للتوضيح فقط. في فضاء حقيقي مئات الأبعاد غير القابلة للقراءة البشرية.',
    ...
    dna: {
        ...
        intro: 'المتجه ليس رقمًا واحدًا. إنه ملف من مكوّنات المعنى تعلّمها النموذج. كل درجة هي مكوّن معنى واحد، وارتفاع العقدة يبيّن مدى قوة ذلك المكوّن في الجملة.',
        roleActive: 'اخترتها',
        roleCompare: 'للمقارنة',
        twistMeaning: 'كلما اقترب معنى الجملتين أكثر، التفّت الخصلتان معًا بإحكام أكبر. وعندما ينزاح المعنى، تتباعدان.',
        ...
        axesNote: 'المحاور هنا تسميات تعليمية. في نموذج حقيقي يضم المتجه مئات أو آلاف الأبعاد الرقمية التي لا تُقرأ كخصائص بشرية.',
    },
