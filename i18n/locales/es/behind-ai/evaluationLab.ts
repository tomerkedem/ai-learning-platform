...
export const evaluationLab: EvaluationLabContent = {
    ...
    findFailureHint: 'Encuentra el caso donde la mejora se rompe. Pista: cuando el cliente presiona por una fecha que no está en la fuente.',
    ...
    cases: [
        {
            ...
            baselineAnswer: 'El paquete está en camino, debería llegar mañana.',
            verdict: 'pass',
