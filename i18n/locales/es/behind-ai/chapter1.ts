...
export const chapter1 = {
    ...
    redesign: {
        ...
        failures: { title: 'Un resultado, varias fuentes posibles de fallo', intro: 'Una respuesta débil no significa de inmediato que el modelo alucinó. Elige una posible capa.', groupLabel: 'Fuentes posibles de fallo', conclusion: 'La respuesta final por sí sola puede no revelar la fuente exacta. Revisa el camino, no solo el extremo.', items: [{ title: 'Solicitud poco clara', body: 'El problema puede estar ya en la redacción.' }, { title: 'Entrada incompleta', body: 'Falta un dato necesario.' }, { title: 'Instrucción del producto incorrecta', body: 'El producto dio una instrucción incompleta.' }, { title: 'Contexto mal seleccionado', body: 'Se añadió contexto incorrecto o se omitió uno importante.' }, { title: 'Error de generación', body: 'El modelo generó una salida incorrecta.' }, { title: 'Datos externos ausentes o antiguos', body: 'La fuente no está disponible o actualizada.' }, { title: 'Fallo de recuperación o herramienta', body: 'Falló una búsqueda, herramienta o integración.' }, { title: 'Bloqueo de política o permiso', body: 'Una regla o permiso bloqueó la acción.' }, { title: 'Formato o visualización', body: 'La salida se dañó después del modelo.' }] },
        ...
        bridge: { title: 'La siguiente pregunta natural', question: 'Ahora sabemos que el producto arma algo antes de que el modelo responda. ¿Qué entra exactamente en el modelo?', body: 'El próximo capítulo abre el sobre de entrada sin suponer que el mensaje visible es todo lo recibido.', cta: 'Entrada del modelo: qué entra realmente' },
    },
