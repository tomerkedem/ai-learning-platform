...
export const chapter1Visuals = {
    ...
    journey: {
        ...
        stations: {
            ...
            s8: { title: 'Mezcla de información', note: 'Cada token pasa por una red feed-forward. Solo en algunos modelos Mixture-of-Experts se activa un subconjunto de expertos.' },
            ...
            s13: { title: 'Elección del siguiente token', note: 'El decoding elige o muestrea un token según la distribución y sus reglas.' },
            s14: { title: 'La respuesta', note: 'El token elegido se añade y se calcula el siguiente paso. Las implementaciones prácticas pueden reutilizar estado ya calculado.' },
        },
        agent: {
            zones: {
            ...
            stations: {
                ...
                a3: { title: 'Herramientas disponibles', note: 'El producto puede exponer herramientas autorizadas, como seguimiento o mensajería. MCP es un protocolo posible, no un requisito.' },
                ...
                a7: { title: 'Llamada a la herramienta', note: 'El producto llama a una herramienta autorizada, como el sistema de seguimiento. Algunos sistemas pueden usar MCP para la conexión.' },
    ...
    readHead: {
        ...
        scriptedNote: 'Ejemplo guiado: cada posición compara una ejecución separada con un prefijo más largo. Las puntuaciones sintéticas son didácticas, no salida interna real ni lectura humana literal.',
