...
export const chapter1Visuals = {
    ...
    enginePanel: {
        ...
        productEnvelope: {
            ...
            systemInstructionExample: 'Responde brevemente en español a preguntas de seguimiento de envíos.',
            selectedContextExample: 'Contexto elegido: soporte de envíos; sin datos externos de seguimiento.',
    ...
    journey: {
        ...
        agent: {
            ...
            mcp: 'MCP (opcional)',
            observation: 'Ejemplo tras una llamada: paquete en clasificación',
