...
// Spanish Chapter 6 ("Attention"). Fallback: re-exports the Hebrew source so the shape
// stays identical and every route renders. Real Spanish translation is a later pass;
