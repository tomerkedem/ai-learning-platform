...
export const guardrailsLab: GuardrailsLabContent = {
    ...
    sectionTitle: 'La misma tarea, cinco acciones, cinco decisiones',
    sectionIntro:
    ...
    actions: [
        ...
        },
        {
            ...
            checks: [
                ...
                { label: 'Permiso', state: 'warn', note: 'Requiere aprobacion humana antes de ejecutarse.' },
            ],
        ...
        },
        {
            ...
            checks: [
                ...
                { label: 'Nivel de riesgo', state: 'fail', note: 'Cambiar un registro oficial sin fundamento.' },
                { label: 'Permiso', state: 'fail', note: 'Una accion prohibida, no pasa ni siquiera con aprobacion.' },
            ],
