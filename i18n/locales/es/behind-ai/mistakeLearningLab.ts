...
export const mistakeLearningLab: MistakeLearningLabContent = {
    ...
    sectionIntro:
        'Un visitante pregunta cuál es el horario de la biblioteca en el feriado. El modelo dio una respuesta equivocada, y tú lo corregiste. Muévete entre los cuatro niveles y observa dónde ocurre de verdad la mejora: en la conversación actual, en el sistema alrededor del modelo, en el entrenamiento de una versión futura, o en la comprobación de que la mejora es real.',
    heading: 'Detrás de la mejora a partir de un error',
    kicker: 'Learning from Mistakes Lab',
    scenarioLabel: 'Pregunta del visitante',
    scenario: '¿Cuál es el horario de la biblioteca en el feriado?',
    ...
    initialAnswer: 'La biblioteca abre de 10:00 a 14:00 en el feriado.',
    correctionLabel: 'Tu corrección',
    correction: 'Eso no es correcto. La fuente no indica el horario de apertura en el feriado.',
    ...
    modes: [
        {
            ...
            steps: [
                { id: 'context-1', label: 'Primera respuesta', text: 'El modelo responde: "La biblioteca abre de 10:00 a 14:00 en el feriado." Es una afirmación sin fuente.', tone: 'wrong' },
                { id: 'context-2', label: 'Tu corrección', text: 'Tú escribes: "Eso no es correcto. La fuente no indica el horario de apertura en el feriado."', tone: 'context' },
                ...
                { id: 'context-4', label: 'Respuesta corregida', text: 'El modelo responde de nuevo: "Cierto. Según la fuente, el horario regular es de 09:00 a 18:00, y el horario de feriado no está disponible."', tone: 'good' },
            ],
            beforeAfter: {
                beforeLabel: 'Antes de la corrección',
                before: 'La biblioteca abre de 10:00 a 14:00 en el feriado.',
                afterLabel: 'Después de la corrección',
                after: 'Según la fuente, el horario regular es de 09:00 a 18:00. El horario de feriado no está disponible.',
            },
        ...
        },
        {
            ...
            steps: [
                ...
                { id: 'system-3', label: 'Mejorar la fuente', text: 'Se mejora la tarjeta de fuente para que marque de forma explícita "horario de feriado no disponible".', tone: 'system' },
        ...
        },
        {
            ...
            steps: [
                { id: 'training-1', label: 'Recoger ejemplos', text: 'Se recogen casos en los que la respuesta inventó un horario de feriado.', tone: 'wrong' },
        ...
        },
        {
            ...
            steps: [
                ...
                { id: 'eval-2', label: 'Versión anterior', text: 'Respondió "abre de 10:00 a 14:00 en el feriado". Falló, porque inventó un horario que no está en la fuente.', tone: 'wrong' },
                { id: 'eval-3', label: 'Versión nueva', text: 'Respondió "el horario de feriado no está disponible en la fuente". Pasó, porque se apoyó en la fuente.', tone: 'good' },
            ...
            beforeAfter: {
                ...
                before: 'Inventa un horario de feriado cuando no hay horario en la fuente.',
                afterLabel: 'Versión nueva',
                after: 'Dice que el horario de feriado no está disponible en la fuente.',
            },
