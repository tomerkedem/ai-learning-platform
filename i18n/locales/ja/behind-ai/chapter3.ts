...
export const chapter3 = {
    ...
    mentorRespond: {
        guessCorrect:
            '分割が理解の後ではなく前に起きることを見抜きました。だからこそ、句読点の違いや数字の追加のように、私たちには同じに見えるものが、モデルにはまったく別物に見えることがあります。',
        guessWrong:
    ...
    lab: {
        ...
        title: '文章をトークンに分ける',
        intro: 'クイックな実験を選ぶか、自分の文章を入力してみましょう。たとえば「洗濯物が乾きませんでした」です。感嘆符や数字を加えたり、別の言語に切り替えたりすると、分割がどう変わるかに注目してください。各単位には色がつき、記号や数字もそれぞれ一つの単位として数えられます。',
    },
    ...
    practical: {
        ...
        points: [
            ...
            '長さやコスト、コンテキストウィンドウが大事なとき、たとえば旅行の計画についての長いやり取りでは、言葉ではなく単位で考えてください。',
