...
export const chapter3 = {
    ...
    insight: {
        title: '意外なポイント',
        lead: 'わたしたちの目には一つの文章。モデルには単位のつながり。',
        body: '同じ内容でも、異なる数の単位になりえます。記号や数字、書き方、そして書く言語によって分割は変わります。この分割は理解ではありません。処理できる形に変える、最初の変換にすぎません。',
    },
