...
export const chapter4Lab: Chapter4LabDict = {
    sentences: {
        ...
        'delivery-not-handed': {
            text: '配送が完了しませんでした',
            tokens: ['配送', 'が', '完了し', 'ませんでした'],
            ttsLine: '配送が完了しませんでした。まったく違う単語だが、意味の方向は同じ。',
        },
        'pkg-arrived': {
            text: '荷物が届きました',
            tokens: ['荷物', 'が', '届きました'],
        ...
        'system-not-showing': {
            ...
            ttsLine: 'システムが荷物を表示しません。配送の問題ではなくシステムの不具合。',
        },
        'billing-address-update': {
            text: '請求先住所を更新しました',
            tokens: ['請求先', '住所', 'を', '更新し', 'ました'],
            ttsLine: '請求先住所を更新しました。配送から遠い話題で、だから地図の遠くに落ちる。',
        },
