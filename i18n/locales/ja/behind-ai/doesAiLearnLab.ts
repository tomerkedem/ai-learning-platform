...
export const doesAiLearnLab: DoesAiLearnLabContent = {
    ...
    layers: [
        ...
        },
        {
            ...
            sees: [
                'フィードバックが送られる。ただし使われる保証はない。',
                'フィードバックは保存またはレビューされることがある。製品による。',
                'のちに適切な例が選ばれることがあり、一部は除外されたり使われなかったりする。',
                '別のプロセスで、システムやモデルが更新されることがある。',
                '更新は、使われる前に評価で確かめられる。',
            ],
            answer: 'もし更新が来れば、そのときに将来の振る舞いは改善しうる。一つの訂正からすぐに起きるわけではない。',
            changed: 'そのようなプロセスの後、システムの将来のバージョンは違う振る舞いをするかもしれない。',
            unchanged: 'プロセスは遅く、あなたの会話とは別で、製品と方針に依存する。一つの訂正がそれを自動で起動することはなく、すべてのユーザー向けにモデルを変えることもない。',
            takeaway: 'フィードバックは即時でも保証された学習でもない。持続的な改善は、評価もされる別の訓練または更新のプロセスであって、一つの訂正からのライブ学習ではない。',
        },
    ],
};
