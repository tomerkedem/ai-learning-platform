...
export const chapter1 = {
    ...
    deep: {
        ...
        hint: 'ここで高度なツールが開きます: ライブな読み取り、確信度ダイヤル、因果、エンジン比較です。自分のペースで探れます。',
        intro1: '深層レイヤーをご覧ください: ここから少し技術的になります。番号付きのラボが四つあり、それぞれが同じ道筋の別の角度を見せます。一度ですべて終える必要はありません。',
        intro2Lead: '',
    ...
    summary: {
        ...
        understandBody: 'AI エンジンは答えを「知っている」わけではありません - 選択肢を順位づけし、その差で判断します。差が大きければ確信して答え、差が小さければ正しい一歩は、推測ではなく止まって尋ねることです。あなた自身がそれを見ました: 読み取りヘッドは読みながら先頭が入れ替わるのを示し、確信度ダイヤルは同じ入力を回答と確認のあいだで反転させ、入れ替えた一語が判断全体をひっくり返しました。',
        ruleTitle: '実践的なルール',
    ...
    beforeQuiz: {
        ...
        footnoteLead: 'この三つをライブで見たいですか?上の ',
        footnoteHighlight: 'エンジン全体',
        footnoteTail: ' を開いて、読み取りヘッド、確信度ダイヤル、エンジン比較で遊んでみてください。',
    },
