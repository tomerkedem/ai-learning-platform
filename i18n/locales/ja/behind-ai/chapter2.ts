...
export const chapter2 = {
    ...
    mentorRespond: {
        guessCorrect:
            'モデルが受け取るのは一つだけ、実際に書かれた文だという点に気づきました。エラーコードのような小さな追加が大きく効くのも同じ理由です。それは入力に入りますが、意図はあなたの側に残ります。',
        guessWrong:
            '自然な思い込みです。人が相手なら、ほのめかすだけで相手が補ってくれます。ここでは一点だけ違います。書かれなかったものは、そもそも届いていません。上の行をもう一度読み、頭の中にあったうちどれが実際に文字になったかを確かめてみてください。',
        quizPass:
            '依頼を読むとき、書かれている内容だけでなく、欠けている情報も見えています。この習慣が、あいまいな依頼を答えられる依頼に変えます。',
        quizFail:
            'ここでの狙いは入力の構成要素を覚えることではなく、書いたことと言いたかったことを分けることです。比較ラボに戻り、言い回しを一つだけ変えて、モデルに何が加わり何が消えるかを見てください。',
    },
