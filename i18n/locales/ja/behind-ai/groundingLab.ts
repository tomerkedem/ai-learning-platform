...
export const groundingLab: GroundingLabContent = {
    ...
    modes: [
        ...
        },
        {
            ...
            badge: 'ungrounded',
            badgeLabel: '合わない出典',
            summary: '出典は取得され、一見問題なさそうだが、別の荷物のものだ。顧客の質問を裏付けていない。',
            source: {
                label: '追跡ステータス（サンプルデータ）',
                caption: '説明のためのサンプルカードです。実際のデータではありません。',
                rows: [
                    { label: 'バーコード', value: 'RR987654321IL' },
                    { label: 'ステータス', value: '配達済み' },
                    { label: '配達時刻', value: '09:14' },
                    { label: '配達先', value: '別の都市' },
                ],
                note: '注意：ここのバーコードは顧客のものとは異なり、配達先も別の都市です。出典は取得されましたが、別の荷物のものです。',
            },
            answer: '取得された出典は別の荷物のもので、バーコードも配達先も異なります。そのため、あなたの質問には答えられません。お答えする前に、あなたの荷物の追跡データが必要です。',
            answerSummary: '出典は存在するが合わないので、答えの根拠には使わない。',
            checks: [
                { id: 'based', state: 'fail', label: '合う出典に基づく？', note: 'いいえ。取得された出典は別の荷物のものなので、この質問への答えを根拠づけられない。' },
                { id: 'invents', state: 'pass', label: 'ステータスをでっち上げている？', note: 'いいえ。答えは別の荷物のステータスを顧客のものとして扱っていない。' },
                { id: 'limits', state: 'pass', label: '出典が合わないことを示している？', note: 'はい。取得された出典が合わないことをはっきり述べ、正しいデータを求めている。' },
            ],
            maySay: '答えは、取得された出典が質問に合わないと述べ、顧客の正しい追跡データを求めることができる。',
            mustNotInvent: '別の荷物のステータスを、顧客のものであるかのように使ってはいけない。',
