    ...
    contexts: [
        {
            id: 'neutral',
            control: '手がかりなし',
            note: '手がかりがないと、「曇り」がいちばん高いスコアを受け取ります。スコアは近いのに、Softmax はもう確率をはっきりと開きます。これはやはり推測であって、確かめた事実ではありません。',
            scores: { delayed: 4, delivered: 3, pickup: 2, lost: 1 },
        },
        {
            id: 'delay',
            control: '朝から曇り',
            promptExtra: '空は早朝からずっと灰色で曇っています。',
            note: '「朝から曇り」という手がかりが「曇り」を後押しし、その周りの分布をくっきりさせます。まったく同じ続きで、スコアだけが違います。',
            scores: { delayed: 5, delivered: 2, pickup: 2, lost: 3 },
        },
        {
            id: 'delivered',
            control: '快晴の予報',
            promptExtra: '予報は快晴で湿度が下がると示しています。',
            note: '快晴の予報が、先頭を「晴れ」へ移します。モデルは実際の空を確かめたのではなく、文脈に書かれたことを重みづけしただけです。',
            scores: { delayed: 3, delivered: 5, pickup: 2, lost: 2 },
        },
        {
            id: 'pickup',
            control: 'レーダーに映る雨',
            promptExtra: '最新のレーダーには雨のバンドが近づいているのが映っています。',
            note: '「レーダーに映る雨」という手がかりが、それに合う続きを先頭へ押し上げます。続きの顔ぶれは変わりません。だれが先頭かは文脈が決めます。',
