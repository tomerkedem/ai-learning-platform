...
export const introduction = {
    ...
    // ── ボーナス: 次のトークンを当てる (NextTokenGuess)。確率は NEXT_TOKEN_META に。 ──
    nextToken: {
        eyebrow: 'ボーナス · あなたがエンジン',
        title: '次のトークンを当てよう',
        subtitle: 'エンジンは真実を選びません。学んだことから最も可能性の高いトークンを選びます。エンジンになったつもりで考えてみてください。',
        guessLabel: '次に来るトークンは？',
        yourPick: 'あなたの予想',
        modelTop: 'エンジンの選択',
        matchTitle: 'エンジンと同じ考えでした！',
        missTitle: 'エンジンが選んだのは',
        otherLabel: 'その他すべて',
        roundLabel: 'ラウンド',
        ofLabel: '/',
        nextRound: '次のラウンド',
        restart: '最初から',
        closing: 'このように、トークンごとに、エンジンの答えは一つずつ組み立てられます。',
        // トークンの順序は NEXT_TOKEN_META の確率の順序と一致します。
        rounds: [
            {
                context: '配送ステータス',
                prefix: '荷物の最新ステータスは：',
                tokens: ['配達済み', '配送中', '仕分け中', '集荷済み', '返送'],
                insight: 'エンジンはあなたの荷物に何が起きたか知りません。こうした文脈で最もよく見た続きを選ぶだけです。',
            },
            {
                context: 'サポート通話',
                prefix: '荷物が届かず電話すると、担当者はこう言った。大変',
                tokens: ['申し訳', '恐縮', '残念', '心配', '嬉しい'],
                insight: '本当に「嬉しい」人などいないと二人とも分かっています。文脈がエンジンを丁寧でありふれた続きへ押しやったのです。',
            },
        ],
    },
