...
export const doesAiLearn = {
    ...
    primer: {
        ...
        points: [
            ...
            {
                title: 'ログとフィードバック',
                body: '製品と設定によっては、フィードバックが記録またはレビューされることがある。ここでは特定の製品についての主張はしない。',
            },
            {
                title: '訓練と更新',
    ...
    see: {
        ...
        caption:
            'ここにはいくつかの異なる層がある。文脈、記憶、ログとフィードバック、そして訓練だ。あなたの訂正は文脈の層に生きており、必ずしもより深い層には届かない。',
    },
    ...
    practical: {
        ...
        uses: [
            ...
            'システムを作るチームへ：規則を定義し、システム指示に加え、情報源に結びつけ、テストケースを作り、繰り返す失敗を集めて管理された改善につなげる。',
            '変更のたびに、振る舞いが本当に良くなったかをもう一度確かめる。',
        ],
        caveat:
            '製品によってデータの扱いは異なる。事実が大事なら、情報源・規則・保存された文脈を明示的に渡し、モデルが「覚えている」ことに頼らないこと。',
    },
