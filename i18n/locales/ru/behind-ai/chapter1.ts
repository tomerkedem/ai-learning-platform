...
export const chapter1 = {
    ...
    deep: {
        ...
        hint: 'Здесь открываются продвинутые инструменты: живое чтение, шкала уверенности, причинность и сравнение движков. Можно исследовать в своём темпе.',
        intro1: 'Перед вами слой глубины: отсюда становится техничнее. Вас ждут четыре пронумерованные лаборатории, каждая показывает свой угол одного и того же маршрута. Не обязательно проходить всё за один раз.',
        intro2Lead: 'В ',
    ...
    beforeQuiz: {
        ...
        footnoteLead: 'Хотите увидеть эти три вживую? Откройте выше ',
        footnoteHighlight: 'движок целиком',
        footnoteTail: ' и поиграйте с головой чтения, шкалой уверенности и сравнением движков.',
    },
