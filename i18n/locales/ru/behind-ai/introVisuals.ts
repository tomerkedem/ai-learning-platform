...
export const introVisuals = {
    ...
    viz: {
        ...
        mix: {
            ...
            caption: 'После внимания каждый токен проходит через feed-forward сеть, которая его обогащает. В больших моделях роутер зажигает лишь несколько экспертов из многих - это Mixture-of-Experts: огромные знания, но на токен работает лишь малая часть.',
        },
