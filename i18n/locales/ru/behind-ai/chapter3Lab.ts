...
export const chapter3Lab: Chapter3LabContent = {
    ...
    splitter: {
        ...
        placeholder: 'Например: Посылка не пришла',
    ...
    signals: {
        ...
        deliveryFailure: { label: 'Сигнал сбоя доставки', en: 'Delivery failure signal' },
        sortingCenter: { label: 'Центр сортировки', en: 'Sorting center' },
    },
    ...
    subword: {
        ...
        splits: [
            { word: 'переслать', whole: ['переслать'], units: ['пере', 'слать'], roleLabel: 'Приставка', roleEn: 'Prefix', note: 'Приставка «пере», означающая заново, может отделиться от основы «слать».' },
            ...
            { word: 'предзаказ', whole: ['предзаказ'], units: ['пред', 'заказ'], roleLabel: 'Приставка', roleEn: 'Prefix', note: 'Приставка «пред» может отделиться от основы «заказ».' },
        ],
    },
    ...
    scenarios: [
        {
            ...
            examples: [
                { labelHe: 'Базовый', labelEn: 'Base', text: 'Посылка не пришла' },
                { labelHe: 'С вопросом', labelEn: 'With question', text: 'Посылка не пришла?' },
                { labelHe: 'С нажимом', labelEn: 'With emphasis', text: 'Моя посылка не пришла!!!' },
                { labelHe: 'Номер отслеживания', labelEn: 'Tracking number', text: 'Номер отслеживания 12345' },
                { labelHe: 'Без пробелов', labelEn: 'No spaces', text: 'Посылканепришла' },
                { labelHe: 'На английском', labelEn: 'In English', text: 'The package did not arrive' },
                { labelHe: 'Исправление', labelEn: 'Correction', text: 'Не туфли, я заказал книгу' },
            ],
        },
        {
            ...
            labelHe: 'Режим Agent',
            labelEn: 'Agent mode',
            prompt: 'Проверь почему посылка не пришла',
            accent: 'purple',
            routeHe: 'Понять задачу',
            routeEn: 'Understand task',
            examples: [
                { labelHe: 'Проверка', labelEn: 'Investigation', text: 'Проверь почему посылка не пришла' },
                { labelHe: 'Для клиента', labelEn: 'To recipient', text: 'Проверь почему посылка не пришла клиенту' },
            ],
        },
    ],
    ...
    roleWords: {
        ...
        проверь: 'action-signal',
        отслеживания: 'context',
        клиенту: 'recipient',
        клиент: 'recipient',
    },

    roleInfo: {
        object: { label: 'Объект', en: 'Object', why: 'Это то, о чём говорит фраза. Движку нужно знать предмет, прежде чем понять, что с ним произошло.' },
        ...
        context: { label: 'Контекст', en: 'Context / Location', why: 'Добавляет место или контекст, который уточняет картину, например куда посылка должна была прийти.' },
        system: { label: 'Система', en: 'System', why: 'Указывает на саму систему, а не на посылку. Та же область, но другое направление.' },
        ...
        number: { label: 'Число', en: 'Number', why: 'Последовательность цифр это самостоятельная единица. Номер отслеживания, например, может превратить общий запрос в то, что можно проверить.' },
    ...
    sortingCenter: { leads: ['центр'], follow: 'сортировки' },
    deliveryFailure: { first: 'не', second: 'пришла' },
};
