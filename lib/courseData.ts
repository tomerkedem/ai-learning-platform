    ...
    "behind-the-scenes-ai": {
        ...
        chapters: [
            ...
            },
            {
                ...
                num: "פרק 1",
                label: { he: "הדרך אל התשובה", en: "The Path to the Answer", ar: "الطريق إلى الجواب", ru: "Путь к ответу", es: "El camino hacia la respuesta", ja: "答えへの道のり" },
                title: { he: "לא רק תשובה - הדרך שמאחורי התשובה", en: "Not Just an Answer - The Path Behind It", ar: "ليس مجرّد جواب - الطريق الذي خلفه", ru: "Не просто ответ - путь, который за ним стоит", es: "No solo una respuesta: el camino que hay detrás", ja: "答えだけではない ― その背後にある道のり" },
            ...
            },
            {
                ...
                num: "פרק 2",
                label: { he: "מה באמת נכנס למודל", en: "What Really Enters the Model", ar: "ما الذي يدخل فعلًا إلى النموذج", ru: "Что на самом деле получает модель", es: "Qué entra realmente en el modelo", ja: "モデルに実際に入るもの" },
                title: { he: "מה באמת נכנס למודל", en: "What Really Enters the Model", ar: "ما الذي يدخل فعلًا إلى النموذج", ru: "Что на самом деле получает модель", es: "Qué entra realmente en el modelo", ja: "モデルに実際に入るもの" },
            ...
            },
            {
                ...
                num: "03",
                label: { he: "Tokenization, הטקסט מתפרק", en: "Tokenization", ar: "Tokenization، تفكّك النص", ru: "Tokenization: текст распадается", es: "Tokenization: el texto se divide", ja: "Tokenization：テキストが分解される" },
                title: { he: "Tokenization, הטקסט מתפרק", en: "Tokenization - Text Splits Into Units", ar: "Tokenization: كيف يتفكّك النص إلى وحدات", ru: "Tokenization - текст распадается на единицы", es: "Tokenization: el texto se divide en unidades", ja: "Tokenization：テキストが単位に分かれる" },
            ...
            },
            {
                ...
                num: "04",
                label: { he: "AI כמנוע הסתברותי", en: "The Probabilistic Heart", ar: "AI كمحرّك احتمالي", ru: "AI как вероятностный движок", es: "AI como motor probabilístico", ja: "確率エンジンとしての AI" },
                title: { he: "AI כמנוע הסתברותי", en: "AI as a Probabilistic Engine", ar: "AI كمحرّك احتمالي", ru: "AI как вероятностный движок", es: "AI como motor probabilístico", ja: "確率エンジンとしての AI" },
            ...
            },
            {
                ...
                num: "06",
                label: { he: "ממילים למספרים", en: "Words to Numbers", ar: "من الكلمات إلى الأرقام", ru: "От слов к числам", es: "De palabras a números", ja: "言葉から数値へ" },
                title: { he: "ממילים למספרים ולמשמעות", en: "From Words to Numbers to Meaning", ar: "من الكلمات إلى الأرقام إلى المعنى", ru: "От слов к числам и смыслу", es: "De palabras a números y significado", ja: "言葉から数値、そして意味へ" },
            ...
            },
            {
                ...
                num: "09",
                label: { he: "מתי לענות ומתי לעצור", en: "When to Answer or Stop", ar: "متى تجيب ومتى تتوقّف", ru: "Когда отвечать и когда остановиться", es: "Cuándo responder y cuándo detenerse", ja: "答えるときと止まるとき" },
                title: { he: "Confidence - מתי לענות ומתי לעצור", en: "Confidence - When to Answer and When to Stop", ar: "Confidence: متى تجيب ومتى تتوقّف", ru: "Confidence - когда отвечать и когда остановиться", es: "Confidence: cuándo responder y cuándo detenerse", ja: "Confidence：答えるときと止まるとき" },
                description: { he: "מודל טוב לא רק יודע לענות, הוא יודע מתי לא לענות. הביטחון אינו רק מספר, הוא שער החלטה שמכריע אם הפער מספיק כדי לפעול.", en: "A good model not only knows how to answer, it knows when not to. Confidence is not just a number, it is a decision gate that decides whether the margin is enough to act.", ar: "النموذج الجيّد لا يعرف كيف يجيب فحسب، بل يعرف متى لا يجيب. الثقة ليست مجرّد رقم، بل بوّابة قرار تحسم ما إذا كان الفارق كافيًا للتصرّف.", ru: "Хорошая модель умеет не только отвечать, но и знает, когда не отвечать. Уверенность - не просто число, а ворота решения, определяющие, достаточен ли разрыв, чтобы действовать.", es: "Un buen modelo no solo sabe responder, también sabe cuándo no hacerlo. La confianza no es solo un número, es una puerta de decisión que determina si la diferencia basta para actuar.", ja: "良いモデルは答え方を知っているだけでなく、答えないときも知っている。確信は単なる数値ではなく、差が行動に足るかを決める判断のゲートだ。" },
                readTime: "14 דקות",
                labelColor: "text-violet-400",
                colorFrom: "from-violet-400",
                colorTo: "to-teal-500"
            },
            {
                ...
                num: "10",
                label: { he: "מ-Prompt למשימה", en: "From Prompt to Task", ar: "من Prompt إلى مهمّة", ru: "От Prompt к задаче", es: "Del Prompt a la tarea", ja: "Prompt からタスクへ" },
                title: { he: "מ-Prompt למשימה - איך Agent מבין מה לעשות", en: "From Prompt to Task - How an Agent Understands What to Do", ar: "من Prompt إلى مهمّة: كيف يفهم Agent ما عليه فعله", ru: "От Prompt к задаче - как Agent понимает, что делать", es: "Del Prompt a la tarea: cómo un Agent entiende qué hacer", ja: "Prompt からタスクへ：Agent はやるべきことをどう理解するか" },
                description: { he: "מילה אחת מהפכת שאלה למשימה. Agent מתחיל בלהבין את המשימה: מה המטרה, מה חסר, ומה מותר. זיהוי משימה אינו אישור לפעול.", en: "One word turns a question into a task. An agent starts by understanding the task: the goal, what is missing, and what is allowed. Detecting a task is not approval to act.", ar: "كلمة واحدة تحوّل سؤالًا إلى مهمّة. يبدأ Agent بفهم المهمّة: ما الهدف، وما الناقص، وما المسموح. التعرّف على المهمّة ليس إذنًا بالتصرّف.", ru: "Одно слово превращает вопрос в задачу. Agent начинает с понимания задачи: какова цель, чего не хватает и что разрешено. Распознать задачу - не значит получить право действовать.", es: "Una palabra convierte una pregunta en una tarea. El Agent empieza por entender la tarea: cuál es el objetivo, qué falta y qué está permitido. Detectar una tarea no es permiso para actuar.", ja: "たった一語が問いをタスクに変える。Agent はまずタスクを理解する：目的は何か、何が足りないか、何が許されているか。タスクを認識することは、行動の許可ではない。" },
                readTime: "14 דקות",
                labelColor: "text-violet-400",
                colorFrom: "from-violet-400",
                colorTo: "to-fuchsia-500"
