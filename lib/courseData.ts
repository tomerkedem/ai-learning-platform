    ...
    "behind-the-scenes-ai": {
        ...
        chapters: [
            ...
            },
            {
                ...
                num: "07",
                label: { he: "Context Window" },
                title: { he: "Context Window: מה המודל באמת רואה עכשיו" },
                description: { he: "המודל לא מחזיק את כל מה שנאמר אי פעם. בכל רגע יש לו חלון הקשר מוגבל, וזה קובע מה נכנס לחישוב, מה עדיין משפיע, ומה כבר נפל מחוץ לתמונה. פרק זה עדיין בבנייה." },
                readTime: "5 דקות",
                labelColor: "text-slate-400",
                colorFrom: "from-slate-400",
            ...
            },
            {
                ...
                num: "09",
                label: { he: "Decoding" },
                title: { he: "Decoding: בחירת הטוקן הבא" },
                description: { he: "אחרי שיש הסתברויות, המודל עדיין צריך לבחור טוקן אחד. כאן נראה איך הבחירה נעשית, ולמה אותה התפלגות יכולה להוביל לתשובות שונות. פרק זה עדיין בבנייה." },
                readTime: "5 דקות",
                labelColor: "text-slate-400",
                colorFrom: "from-slate-400",
                colorTo: "to-slate-600"
