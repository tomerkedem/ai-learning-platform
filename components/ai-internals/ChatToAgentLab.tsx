...
//
// הרעיון המרכזי: אותה בקשה בדיוק, "ארגן פגישת תכנון פרויקט בת 30 דקות ושלח הזמנה",
// נענית בחמישה מצבים:
//   1. צ'אט (תשובה בלבד): מקבל קלט ומחזיר תשובה, בלי כלי ובלי פעולה.
//   2. Agent, מידע חסר: אין טווח זמן מתאים, אז הוא שואל במקום לנחש.
//   3. Agent, שימוש בכלי: יש טווח זמן מתאים, אז הוא בוחר כלי בדיקת יומן ומנסח לפי התוצאה.
//   4. Agent, דרוש אישור: הצעד הבא הוא שליחת ההזמנה, פעולה רגישה שנעצרת לאישור.
//   5. Agent, תקלת כלי: כלי בדיקת היומן נכשל, אז הוא מדווח על הכשל במקום להמציא תוצאה,
//      בתוך גבול ניסיון חוזר אחד בלבד.
...
// יומן, אין שליחת הודעה אמיתית, ואין שרשרת חשיבה נסתרת. כל הטקסט תלוי-השפה מגיע
