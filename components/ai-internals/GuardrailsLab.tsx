...
// אישור ועצירה").
//
// הרעיון המרכזי: אותה משימה בדיוק, "ארגן פגישת תכנון פרויקט בת 30 דקות ושלח הזמנה",
// מובילה לשש פעולות שונות, וכל פעולה עוברת שכבת בקרה:
//   1. בקשת מידע חסר: אין טווח זמן מתאים, עוצרים ושואלים.
//   2. בדיקת זמינות ביומן: קריאה בלבד, סיכון נמוך, מותר.
//   3. ניסוח טיוטה: פונה למשתתפים אבל לא נשלח, טיוטה בלבד.
//   4. שליחת הזמנה: פעולה חיצונית, סיכון גבוה, דרוש אישור.
//   5. סימון כמאושר בלי בסיס במקור: פעולה חסומה.
//   6. ניסיון חוזר ללא גבול: המערכת עוצרת בגבול של ניסיון ראשון ועוד ניסיון חוזר אחד.
...
// יומן, אין שליחת הודעה אמיתית, אין שינוי סטטוס אמיתי, ואין שרשרת חשיבה נסתרת. כל
