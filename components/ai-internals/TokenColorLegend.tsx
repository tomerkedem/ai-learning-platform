 ...
 * התצוגות, כך שאפשר לזהות תפקיד במבט אחד.
 */
        ...
        <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-5 text-right" dir="rtl">
            <div className="mb-3 flex items-center gap-2">
                ...
                <div className="leading-tight">
                    <div className="text-sm font-bold text-slate-200">מפת צבעי התפקידים</div>
                    <div className="text-[10px] font-medium uppercase tracking-[0.2em] text-slate-500">Token Color Map</div>
                </div>
            </div>
                    ...
                    return (
                        <div key={role} className={`flex items-center gap-2 rounded-lg border ${s.border} ${s.bg} px-2 py-1.5`}>
                            ...
                            <span className="leading-tight">
                                <span className={`block text-[11px] font-bold ${s.text}`}>{info.he}</span>
