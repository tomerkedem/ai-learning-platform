...
import { analyzeSentence, analyzeAgent, AGENT_TEMPERATURE } from '@/app/(course)/behind-the-scenes-ai/chapter-6/pipelineData';
import { softmax, confidenceFromMargin, type ConfidenceLevel } from '@/app/(course)/behind-the-scenes-ai/chapter-6/scoringEngine';
