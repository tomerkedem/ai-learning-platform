    ...
    return (
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={18}>
            ...
            <div className="relative">
                ...
                {/* המנטור: יכול לבצע לא אומר שמותר. ממוקם בצד החיצוני לפי כיוון הקריאה. */}
                <div className={`pointer-events-none absolute top-1/2 z-20 hidden w-[248px] -translate-y-1/2 xl:block ${isRtl ? 'left-full ml-3 2xl:ml-6' : 'right-full mr-3 2xl:mr-6'}`}>
                    <Mentor pose="explain-opposite" line={c18.mentor.hero} width={248} flip={!isRtl} />
                </div>
            </div>
            ...
            {/* ══════════ מעבדת ה-Guardrails ══════════ */}
            <section id="guardrails-lab" className="relative mt-12 space-y-5 text-start scroll-mt-24" dir={dir}>
                ...
                {/* המנטור: עברו בין הפעולות וראו מה משתנה */}
                <div className={`absolute top-1/2 -translate-y-1/2 z-20 hidden xl:block pointer-events-none ${isRtl ? 'right-full mr-3 2xl:mr-6' : 'left-full ml-3 2xl:ml-6'}`}>
                    <Mentor pose="inspect" line={c18.mentor.labExplain} width={160} flip={!isRtl} />
                </div>
            </section>
            ...
            <section className="relative mt-12 text-start" dir={dir}>
                <div className={`absolute top-1/2 -translate-y-1/2 z-20 hidden xl:block pointer-events-none ${isRtl ? 'left-full ml-3 2xl:ml-6' : 'right-full mr-3 2xl:mr-6'}`}>
                    <Mentor pose="reassure" line={c18.mentor.misconception} width={160} flip={!isRtl} />
                </div>
            ...
            <section className="relative mt-12 text-start" dir={dir}>
                <div className={`absolute top-1/2 -translate-y-1/2 z-20 hidden xl:block pointer-events-none ${isRtl ? 'left-full ml-3 2xl:ml-6' : 'right-full mr-3 2xl:mr-6'}`}>
                    <Mentor pose="pointdown" line={c18.mentor.practical} width={160} flip={!isRtl} />
                </div>
