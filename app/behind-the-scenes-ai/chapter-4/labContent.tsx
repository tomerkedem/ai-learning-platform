...
export interface Chapter4LabDict {
    ...
    dna: {
        title: string;
        /** מסגור קבוע: למה זה DNA ומה כל שלב מייצג (שני גדילים = שני משפטים, שלב = רכיב). */
        intro: string;
        /** תווית תפקיד במקרא: הגדיל הציאן הוא המשפט שהלומד בחר. */
        roleActive: string;
        /** תווית תפקיד במקרא: הגדיל הסגול הוא המשפט שאליו משווים. */
        roleCompare: string;
        /** הסבר משמעות הפיתול: ככל שהמשמעות קרובה יותר, הגדילים נכרכים הדוק יותר. */
        twistMeaning: string;
