...
export default function BehindTheScenesChapter15() {
    ...
    return (
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={15}>
            ...
            {/* ══════════ מבדק הבנה ══════════ */}
            <section className="mt-10 rounded-2xl border border-indigo-500/30 bg-indigo-950/15 p-5 text-start" dir={dir}><div className="text-xs font-bold text-indigo-300">{cq.nextQuestionLabel}</div><p className="mt-2 text-base leading-relaxed text-slate-200">{cq.transitions[15]}</p></section>
