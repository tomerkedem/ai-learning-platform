// נתוני פרק 13: "עצירה, אישור ואחריות".
...
export const NARRATION: Record<string, SectionNarration> = {
    ...
    approval: {
        ...
        intro: 'כמו שער הביטחון מפרק 9, זה שער נוסף, ומופעל כשהפעולה רגישה. הנקודה הקריטית: ביטחון גבוה לא מבטל את הצורך באישור כשהפעולה מסוכנת. גם אם ה-Agent בטוח, פעולה מול לקוח דורשת אדם.',
