...
import { BehindScenesLab } from './BehindScenesLab';
import { Mentor } from '@/components/ai-internals/Mentor';

// פרק מוקפא (parked): המעבדה המאוחדת הישנה של פרק 14 (Chat מול Agent על אותו מסך).
// נשמר תחת _parked/full-agent-trace לשימוש עתידי בפרקי ה-Agent (17-19, במיוחד Full Trace).
// אינו מחווט לשום route פעיל.
export default function FullAgentTracePage() {
