...
import { PromptCoachLab } from './PromptCoachLab';
import { Mentor } from '@/components/ai-internals/Mentor';

// ── מוקפא (parked) ──────────────────────────────────────────────────────────
// זהו פרק הסיום הישן "מאמן הבקשות" (Prompt Coach), שהוקפא כשפרק 16 הפך ל-
// "האם AI לומד ממני" (Does AI Learn From Me). התוכן נשמר כאן כמות שהוא לצורך
// שחזור עתידי. הוא אינו מנותב (תיקיית _parked פרטית ב-App Router) ואינו רשום
// בניווט. מבדק הפרק הישן שמור לצד הקובץ הזה תחת promptCoachQuiz.ts.
