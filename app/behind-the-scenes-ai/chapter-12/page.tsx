...
import { Database, MousePointerClick, Layers, FlaskConical, Lightbulb, ListChecks, CheckCircle2, XCircle, Sparkles, Link2, GraduationCap, Globe, ShieldCheck, ArrowLeft, ArrowRight } from 'lucide-react';
...
export default function BehindTheScenesChapter12() {
    ...
    const sBridge: ReadAloudSegment = { id: 'bridge', label: t.behindAi.chapterQuiz.nextQuestionLabel, text: t.behindAi.chapterQuiz.transitions[12] };
    ...
    return (
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={12} themeAware>
            ...
            <div className="relative">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[color-mix(in_oklab,color-mix(in_oklab,var(--bts-surface-elevated)_var(--bts-tint-mix),var(--color-slate-800))_70%,transparent)] border border-teal-500/30 mb-5">
                        ...
                        <div className="flex items-start gap-2.5 max-w-3xl">
                            <p className="text-lg text-[var(--bts-text-secondary)] leading-relaxed">{c12.hero.lede}</p>
                ...
                {/* M9: מנטור ההירו הוסר. הבועה ("תנו למודל על מה להישען") היא בדיוק המסקנה של
            ...
            <section className="mt-12 text-start" dir={dir}>
                ...
                <OpeningGuess
                    ...
                    mentorResponse={{ correct: c12.mentorRespond.guessCorrect, wrong: c12.mentorRespond.guessWrong }}
                />
            </section>
                ...
                <div className="rounded-[2rem] border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-from)_50%,transparent)] p-6 backdrop-blur-xl md:p-8">
                    <div className="mb-4 flex items-start justify-between gap-2.5">
                        <div>
                            ...
                            <h3 className="text-xl font-black text-[var(--bts-text-primary)] md:text-2xl">{c12.primer.title}</h3>
                            <p className="mt-1 text-sm font-medium text-[var(--bts-text-muted)]">{c12.primer.subtitle}</p>
                        </div>
                        <SpeakButton text={primerText} speechLocale={speechLocale} />
                    </div>

                    <p className="text-[15px] leading-relaxed text-[var(--bts-text-secondary)] md:text-base">{c12.primer.lead}</p>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <div className="rounded-2xl border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-from)_40%,transparent)] p-5">
                            ...
                            <React.Fragment key={step}>
                                <span className={`rounded-full border px-3 py-1.5 text-sm font-bold ${
                                    i === c12.see.steps.length - 1
                                        ? 'border-teal-400/50 bg-[color-mix(in_oklab,color-mix(in_oklab,var(--t-l)_var(--bts-tint-mix),var(--t-d))_calc(20%_-_var(--bts-tint-mix)_*_0.1),transparent)] [--t-d:var(--color-teal-900)] [--t-l:var(--color-teal-500)] text-teal-200'
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-[var(--bts-text-muted)]">{c12.see.caption}</p>
                </div>
            </section>
            ...
            <section id="grounding-lab" className="mt-12 space-y-5 text-start scroll-mt-24" dir={dir}>
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-[var(--bts-text-primary)]">{c12.lab.sectionTitle}</h3>
                    </div>
                </div>
                ...
                {/* M9: המנטור "אותה שאלה, מקור משנה הכל" הוסר. מבוא המעבדה שמעליו כבר אומר
                ...
                <div className="rounded-2xl border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-from)_40%,transparent)] p-5 leading-relaxed text-[var(--bts-text-secondary)]">
                    <div className="mb-3 flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm font-bold text-[var(--bts-text-bright)]">{c12.analogy.title}</div>
                        </div>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-rose-500/30 bg-[color-mix(in_oklab,color-mix(in_oklab,var(--t-l)_var(--bts-tint-mix),var(--t-d))_calc(10%_-_var(--bts-tint-mix)_*_0.05),transparent)] [--t-d:var(--color-rose-950)] [--t-l:var(--color-rose-500)] p-5">
                        ...
                        <p className="leading-relaxed text-[var(--bts-text-secondary)]">{c12.misconception.wrongQuote}</p>
                    </div>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <div className="rounded-2xl border border-teal-500/40 bg-[var(--bts-surface)] p-6">
                    <div className="mb-5 flex items-center gap-2">
                        ...
                        <h3 className="text-xl font-bold text-[var(--bts-text-primary)]">{c12.lock.title}</h3>
                    </div>
            ...
            <section className="mt-16 mb-4" dir={dir}>
                <ExpandableLab title={localizedQuiz.title}>
                    ...
                    <AssessmentEngine
                        ...
                        mentorResponse={{ pass: c12.mentorRespond.quizPass, fail: c12.mentorRespond.quizFail }}
                    />
                </ExpandableLab>
            </section>
        </ChapterLayout>
