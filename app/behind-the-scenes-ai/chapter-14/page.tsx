        ...
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={14}>
            ...
            <div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800/70 border border-fuchsia-500/30 mb-5">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black text-white leading-[1.1] mb-4">
                            {c14.hero.titleLead}{' '}
                            <span className={`${isRtl ? 'bg-gradient-to-l' : 'bg-gradient-to-r'} from-fuchsia-400 via-violet-400 to-amber-400 bg-clip-text text-transparent`}>
                                {c14.hero.titleHighlight}
                            </span>
                        </h1>

                        <div className="flex items-start gap-2.5 max-w-3xl">
                            <p className="text-lg text-slate-300 leading-relaxed">{c14.hero.lede}</p>
                ...
                <div className="rounded-[2rem] border border-slate-700/50 bg-slate-900/50 p-6 backdrop-blur-xl md:p-8">
                    <div className="mb-4 flex items-start justify-between gap-2.5">
                        <div>
                            ...
                            <h3 className="text-xl font-black text-white md:text-2xl">{c14.primer.title}</h3>
                            <p className="mt-1 text-sm font-medium text-slate-400">{c14.primer.subtitle}</p>
                        </div>
                        <SpeakButton text={primerText} speechLocale={speechLocale} />
                    </div>

                    <p className="text-[15px] leading-relaxed text-slate-300 md:text-base">{c14.primer.lead}</p>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <div className="rounded-2xl border border-slate-700/50 bg-slate-900/40 p-5">
                    <div className="mb-3 flex items-center justify-between gap-2">
                        <div className="text-sm font-bold text-slate-100">{c14.see.title}</div>
                            ...
                            <React.Fragment key={step}>
                                <span className={`rounded-full border px-3 py-1.5 text-sm font-bold ${
                                    i === c14.see.steps.length - 1
                                        ? 'border-fuchsia-400/50 bg-fuchsia-900/20 text-fuchsia-200'
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-slate-400">{c14.see.caption}</p>
                </div>
            </section>
            ...
            <section id="mistake-learning-lab" className="mt-12 space-y-5 text-start scroll-mt-24" dir={dir}>
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-white">{c14.lab.sectionTitle}</h3>
                    </div>
                </div>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-rose-500/30 bg-rose-950/10 p-5">
                        ...
                        <p className="leading-relaxed text-slate-300">{c14.misconception.wrongQuote}</p>
                    </div>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <InsightBox type="intuition" title={c14.practical.title}>
                    ...
                    <span className="mt-3 block text-sm text-slate-400">{c14.practical.caveat}</span>
                </InsightBox>
            </section>
