...
// קופי הכרטיס והדמו החי מגיעים מהמילון (intro.agent). כאן רק הטיפוסים והמבנה של הדמו.
...
export const AGENT_DEMO = {
    ...
    input: { label: 'בקשה', text: 'מצא לי מקום לארוחת ערב הערב לשניים, בדוק זמינות, והזמן רק אחרי שאאשר' },
    output: { label: 'תשובה', agent: 'שולחן ל-2 הוזמן ל-19:30, אחרי האישור', chat: 'אני יכול להציע אפשרויות, אבל לא לבדוק זמינות בזמן אמת או להזמין שולחן.' },
    agentStages: [
        { id: 'in', label: 'קלט', hint: 'הבקשה שלכם נכנסת אל המערכת, ומכאן מתחיל הסבב.' },
        { id: 'task', label: 'מבין מטרה', hint: 'ארוחת ערב הערב לשניים, והזמנה רק באישור.', intent: 'ארוחת ערב לשניים, הערב' },
        { id: 'tool', label: 'משתמש בכלים', hint: 'חיפוש ובדיקת זמינות: מידע חי שהמודל לבדו לא רואה.', tool: 'חיפוש + זמינות' },
        { id: 'act', label: 'מקבל תוצאה', hint: 'נמצא שולחן פנוי. הכול מוכן להזמנה, אבל עדיין לא הוזמן דבר.', next: 'פנוי הערב ב-19:30' },
        { id: 'risk', label: 'מבקש אישור', hint: 'הפעולה החיצונית נעצרת עד שתאשרו אותה.', risk: 'להזמין שולחן ל-2 ב-19:30?' },
        { id: 'answer', label: 'מבצע הזמנה', hint: 'רק אחרי האישור, כלי ההזמנה שומר את השולחן ומחזיר אישור.', next: 'השולחן הוזמן ל-19:30' },
    ] as AgentStage[],
    chatStages: [
        { id: 'in', label: 'קלט', hint: 'הבקשה שלכם נכנסת.' },
        { id: 'model', label: 'מודל', hint: 'המודל מייצר תשובה טקסטואלית.' },
        { id: 'out', label: 'תשובה', hint: 'טקסט אחד חוזר אליכם, בלי בדיקה חיה ובלי פעולה בעולם.' },
    ] as AgentStage[],
} as const;
