...
import { ScanSearch, MousePointerClick, Layers, FlaskConical, Lightbulb, Lock, CheckCircle2, XCircle, Sparkles, BadgeCheck, CalendarClock, AlignLeft, ArrowLeft, ArrowRight } from 'lucide-react';
        ...
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={11}>
            ...
            <div className="relative">
                ...
                <div className={`pointer-events-none absolute top-1/2 z-20 hidden w-[248px] -translate-y-1/2 xl:block ${isRtl ? 'left-full ml-3 2xl:ml-6' : 'right-full mr-3 2xl:mr-6'}`}>
                    <Mentor pose="headsup" line={c11.mentor.hero} width={248} flip={!isRtl} />
                </div>
            </div>
