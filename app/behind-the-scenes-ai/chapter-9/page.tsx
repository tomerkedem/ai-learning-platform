...
const ReadingPath: React.FC = () => (
    <div className="rounded-2xl border border-slate-700/50 bg-slate-900/40 p-5 text-right leading-relaxed text-slate-300" dir="rtl">
        ...
        <p className="text-sm">
            ...
            השני של הקורס, חצי ה-Agent. ה-Agent לא מתחיל מלהפעיל כלי, הוא מתחיל מלהבין את המשימה: מה המטרה, מה חסר, והאם בכלל
            ...
            <section className="mt-12 text-right" dir="rtl">
                <InsightBox type="intuition" title="הנקודה החשובה בפרק">
                    ...
                    <span className="mt-3 block text-sm text-slate-400">
                        שינוי קטן בקלט מספיק כדי להעביר את ה-Agent בין מצבים. וכש&quot;Ready for tool selection&quot; מופיע, השלב הבא הוא בחירת הכלי המתאים, וזה בדיוק מה שנפתח בפרק 10.
                    </span>
                </InsightBox>
            </section>
