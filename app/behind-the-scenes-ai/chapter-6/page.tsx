...
const DiagnosisQuestion: React.FC = () => {
    ...
    return (
        <div dir={dir} className="text-start">
            ...
            <p className="mb-4 rounded-lg border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-to)_40%,transparent)] p-3 text-sm text-[var(--bts-text-secondary)]">{c6.prompt}</p>
...
export default function BehindTheScenesChapter6() {
    ...
    return (
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={6} themeAware>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-start gap-2.5 max-w-3xl">
                            <p className="text-lg text-[var(--bts-text-secondary)] leading-relaxed">{c6.hero.lede}</p>
                        ...
                        <div className="mt-6 rounded-2xl border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-to)_40%,transparent)] p-4">
                            ...
                            <p className="text-base font-bold text-[var(--bts-text-bright)]">{c6.prompt}</p>
                        </div>
                ...
                <div className="rounded-[2rem] border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-from)_50%,transparent)] p-6 backdrop-blur-xl md:p-8">
                    <div className="mb-4 flex items-start justify-between gap-2.5">
                        <div>
                            ...
                            <h3 className="text-xl font-black text-[var(--bts-text-primary)] md:text-2xl">{c6.primer.title}</h3>
                        </div>
                        <SpeakButton text={primerText} speechLocale={speechLocale} />
                    </div>

                    <p className="text-[15px] leading-relaxed text-[var(--bts-text-secondary)] md:text-base">{c6.primer.lead}</p>
            ...
            <section id="attention-lab" className="mt-12 space-y-5 text-start scroll-mt-24" dir={dir}>
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-[var(--bts-text-primary)]">{c6.sentenceLab.sectionTitle}</h3>
                    </div>
                </div>

                <div className="flex items-start gap-2.5">
                    <p className="text-base leading-relaxed text-[var(--bts-text-secondary)]">{c6.sentenceLab.sectionIntro}</p>
                ...
                <div className="rounded-2xl border border-[var(--bts-border)] bg-[color-mix(in_oklab,var(--bts-panel-from)_40%,transparent)] p-5 leading-relaxed text-[var(--bts-text-secondary)]">
                    <div className="mb-3 flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm font-bold text-[var(--bts-text-bright)]">{c6.everyday.title}</div>
                        </div>
            ...
            <section className="mt-12 text-start" dir={dir}>
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-rose-500/30 bg-[color-mix(in_oklab,color-mix(in_oklab,var(--t-l)_var(--bts-tint-mix),var(--t-d))_calc(10%_-_var(--bts-tint-mix)_*_0.05),transparent)] [--t-d:var(--color-rose-950)] [--t-l:var(--color-rose-500)] p-5">
                        ...
                        <p className="leading-relaxed text-[var(--bts-text-secondary)]">{c6.mistake.wrong}</p>
                    </div>
                    <div className="rounded-2xl border border-emerald-500/30 bg-[color-mix(in_oklab,color-mix(in_oklab,var(--t-l)_var(--bts-tint-mix),var(--t-d))_calc(10%_-_var(--bts-tint-mix)_*_0.05),transparent)] [--t-d:var(--color-emerald-950)] [--t-l:var(--color-emerald-500)] p-5">
                        ...
                        <p className="leading-relaxed text-[var(--bts-text-secondary)]">{c6.mistake.right}</p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="mb-3 flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="leading-tight">
                                <div className="text-sm font-bold text-[var(--bts-text-bright)]">{c6.qkv.title}</div>
                                <div className="text-[11px] font-medium uppercase tracking-[0.2em] text-[var(--bts-text-faint)]" dir="ltr">{c6.qkv.sub}</div>
                            </div>
                        </div>
                ...
                <div className="rounded-2xl border border-violet-500/40 bg-[color-mix(in_oklab,var(--bts-panel-from)_60%,transparent)] p-6">
                    <div className="mb-5 flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-xl font-bold text-[var(--bts-text-primary)]">{c6.lock.title}</h3>
                        </div>
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                        <div className="rounded-xl border border-emerald-500/30 bg-[color-mix(in_oklab,color-mix(in_oklab,var(--t-l)_var(--bts-tint-mix),var(--t-d))_calc(10%_-_var(--bts-tint-mix)_*_0.05),transparent)] [--t-d:var(--color-emerald-950)] [--t-l:var(--color-emerald-500)] p-4">
                            ...
                            <p className="text-sm leading-relaxed text-[var(--bts-text-body)]">{c6.lock.trueText}</p>
                        </div>
                        <div className="rounded-xl border border-rose-500/30 bg-[color-mix(in_oklab,color-mix(in_oklab,var(--t-l)_var(--bts-tint-mix),var(--t-d))_calc(10%_-_var(--bts-tint-mix)_*_0.05),transparent)] [--t-d:var(--color-rose-950)] [--t-l:var(--color-rose-500)] p-4">
                            ...
                            <p className="text-sm leading-relaxed text-[var(--bts-text-body)]">{c6.lock.falseText}</p>
                        </div>
                    </div>
