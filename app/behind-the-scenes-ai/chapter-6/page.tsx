    ...
    return (
        <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-5 text-right" dir="rtl">
            ...
            <p className="mt-4 text-xs leading-relaxed text-slate-400">
                בפרק הזה עברנו שני שלבים בבת אחת: כל טוקן קיבל Token ID, ומהרצף הזה נבנה וקטור משמעות. בפרק הבא ניכנס למרחב המשמעות עצמו ונבין את הקרבה הזו גיאומטרית, איך מילים הופכות לנקודות וחצים ולמה הכיוון קובע. את החישוב המלא של הדמיון, שהופך קרבה לאחוזים, נפתח מיד לאחר מכן.
            </p>
        </div>
    );
};
    ...
    return (
        <ChapterLayout courseId="behind-the-scenes-ai" currentChapterId={6}>
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-lg text-slate-300 leading-relaxed max-w-3xl">
                        המנוע לא יכול לעבוד עם מילים כמו שאנחנו קוראים אותן. כדי לחשב ולהשוות משמעות, הוא קודם הופך את הטקסט
                        למספרים. הקלידו משפט, וראו אותו נהפך לרצף מספרים ואז לפרופיל משמעות חי. בשפה המקצועית: קודם Token IDs, ואז
                        Meaning Vector. הרגע המפתיע הוא ששני משפטים עם מילים שונות לגמרי יכולים להצביע לאותו כיוון.
                    </p>
            ...
            <section className="mt-16 mb-4" dir="rtl">
                <AssessmentEngine {...behindAiChapterQuizzes[6]} />
            </section>
        </ChapterLayout>
    );
}
