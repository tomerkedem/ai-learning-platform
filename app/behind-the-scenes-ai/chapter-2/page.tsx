            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-lg text-slate-300 leading-relaxed max-w-3xl">
                        בפרק הזה נראה איך אותה בקשה, מנוסחת בכמה דרכים, מובילה את המנוע למסלולים שונים. הטעות הנפוצה היא לחשוב שהמנוע
                        מגיב לנושא של המשפט. בפועל הוא מגיב לכוונה שמאחורי הניסוח, ומנתב כל בקשה למסלול אחר: לענות, לבקש מידע, להתכונן
                        לכלי, או לעצור לאישור. בחרו ניסוח וראו איך אותו נושא בדיוק מוביל להחלטה אחרת.
                    </p>
